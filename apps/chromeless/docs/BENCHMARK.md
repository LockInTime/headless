...
| --- | ---: | ---: | ---: | ---: |
| Chromeless, cold | 194 | 5,002 ms | 1,478 ms | 279 MiB |
| Chromeless, warm | 147 | 4,753 ms | 842 ms | 276 MiB |
...
Chromeless has the smallest agent surface: the warm workflow uses about 64%
...
Chromeless case starts its host and session before timing; the cold case
includes them.
...
native distribution Chromium binary and confirm it with `chromeless runtime`.
