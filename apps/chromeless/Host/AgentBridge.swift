...
private let agentWorld = WKContentWorld.world(name: "ChromelessAgent")
...
extension BrowserWindowController {
    ...
    func agentClick(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        return try callAgent("return globalThis.__chromelessAgent.click(args);", arguments: ["args": args])
    }
    ...
    func agentFill(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        args["value"] = value
        return try callAgent("return globalThis.__chromelessAgent.fill(args);", arguments: ["args": args])
    }
    ...
    func agentPress(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        return try callAgent("return globalThis.__chromelessAgent.press(key);", arguments: ["key": key])
    }
    ...
    func agentScroll(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        return try callAgent("return globalThis.__chromelessAgent.scroll(args);", arguments: ["args": args])
    }
    ...
    func agentWait(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        repeat {
            lastState = try callAgent("return globalThis.__chromelessAgent.state();")
    ...
    func agentCaptureInfo() throws -> JSONValue {
        ...
        let state = try callAgent("return globalThis.__chromelessAgent.state();")
    ...
    func agentScreenshot(parameters: [String: JSONValue]) throws -> Data {
        ...
        if hasTarget {
            ...
            let value = try callAgent(
                "return globalThis.__chromelessAgent.rectangle(args);", arguments: ["args": args]
            )
    ...
    func agentStyles(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        return try callAgent("return globalThis.__chromelessAgent.styles(args);", arguments: ["args": input])
    }
    ...
    func agentPerformance() throws -> JSONValue {
        try callAgent("return globalThis.__chromelessAgent.performance();")
    }

    func agentAnimations() throws -> JSONValue {
        try callAgent("return globalThis.__chromelessAgent.animations();")
    }
