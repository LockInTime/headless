...
public final class ArtifactStore: @unchecked Sendable {
    ...
    public init(environment: [String: String] = ProcessInfo.processInfo.environment) throws {
        if let override = environment["CHROMELESS_ARTIFACT_DIR"] {
            ...
            rootURL = FileManager.default.homeDirectoryForCurrentUser
                .appendingPathComponent("Library/Application Support/Chromeless/Artifacts", isDirectory: true)
            #else
            let base: URL
            ...
            rootURL = base.appendingPathComponent("chromeless/artifacts", isDirectory: true)
            #endif
        }
        try prepareRoot()
    }
