...
private func spawnChromium(executable: URL, arguments: [String]) throws -> SpawnedChromium {
    ...
    do {
        ...
        let keepErrorOutput = ProcessInfo.processInfo.environment["CHROMELESS_DEBUG"] == "1"
...
final class ChromiumProcess {
    ...
    init() throws {
        ...
        headless = ProcessInfo.processInfo.environment["CHROMELESS_HEADLESS"] != "0"
    ...
    private static func resolveExecutable() throws -> URL {
        ...
        let candidates = [
            environment["CHROMELESS_CHROMIUM_EXECUTABLE"],
...
final class LinuxBrowserSession: @unchecked Sendable {
    ...
    func inspect(interactive: Bool, includeText: Bool) throws -> JSONValue {
        try evaluate(
            "return globalThis.__chromelessAgent.snapshot(interactive, includeText);",
    ...
    func click(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        let result = try evaluate("return globalThis.__chromelessAgent.click(args);", input: ["args": args])
    ...
    func fill(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        args["value"] = value
        return try evaluate("return globalThis.__chromelessAgent.fill(args);", input: ["args": args])
    }
    ...
    func press(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        return try evaluate("return globalThis.__chromelessAgent.press(key);", input: ["key": key])
    }
    ...
    func scroll(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        return try evaluate("return globalThis.__chromelessAgent.scroll(args);", input: ["args": args])
    }
    ...
    func wait(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        repeat {
            do {
                state = try evaluate("return globalThis.__chromelessAgent.state();")
    ...
    func tour(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        return try evaluate(
            "return await globalThis.__chromelessAgent.tour(args);",
    ...
    func state() throws -> JSONValue { try evaluate("return globalThis.__chromelessAgent.state();") }
    ...
    func screenshot(
        ...
        if hasTarget {
            ...
            let rectangle = try evaluate(
                "return globalThis.__chromelessAgent.rectangle(args);", input: ["args": args]
            )
    ...
    func styles(parameters: [String: JSONValue]) throws -> JSONValue {
        ...
        return try evaluate("return globalThis.__chromelessAgent.styles(args);", input: ["args": args])
    }

    func storage(scope: String, includeValues: Bool) throws -> JSONValue {
        try requireSensitiveDiagnosticsIfNeeded(includeValues)
        return try evaluate(
            "return globalThis.__chromelessAgent.storage(args);",
            input: ["args": ["scope": scope, "includeValues": includeValues]]
        )
    }

    func performance() throws -> JSONValue {
        try evaluate("return globalThis.__chromelessAgent.performance();")
    }

    func animations() throws -> JSONValue {
        try evaluate("return globalThis.__chromelessAgent.animations();")
    }
    ...
    /// discover or replace `__chromelessAgent`, while the world still has DOM
    ...
    private func requireSensitiveDiagnosticsIfNeeded(_ requested: Bool) throws {
        guard !requested || ProcessInfo.processInfo.environment["CHROMELESS_ALLOW_SENSITIVE_DIAGNOSTICS"] == "1" else {
